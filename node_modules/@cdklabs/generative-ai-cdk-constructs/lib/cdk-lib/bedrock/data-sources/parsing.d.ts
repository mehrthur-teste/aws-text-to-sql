...
export declare enum ParsingModality {
    /**
 ...
 */
export declare enum ParsingStategyType {
    /**
 ...
 */
export declare abstract class ParsingStategy {
    /**
     ...
     */
    static foundationModel(props: FoundationModelParsingStategyProps): ParsingStategy;
    /** The CloudFormation property representation of this configuration */
    abstract configuration: CfnDataSource.ParsingConfigurationProperty;
